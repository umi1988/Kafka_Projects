...
public class KafkaMessageConsumer {
    ...
    @KafkaListener(topics = "${app.topic.name}", groupId = "error-handler-group")
    public void consumeEvents(User user, @Header(KafkaHeaders.RECEIVED_TOPIC) String topic, @Header(KafkaHeaders.OFFSET) long offset) throws JsonProcessingException {
